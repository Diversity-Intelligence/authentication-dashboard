...
export const FIRST_FACTOR_IDS = [
  {
    ...
    description:
      'Sign in/up using email and password (Requires the EmailPassword recipe to be initialized)',
    id: 'emailpassword',
  },
  {
    label: 'OTP - Email',
    description:
      'Sign in/up using OTP sent to email (Requires the Passwordless recipe to be initialized)',
    id: 'otp-email',
  },
  {
    label: 'OTP - Phone',
    description:
      'Sign in/up using OTP sent to phone (Requires the Passwordless recipe to be initialized)',
    id: 'otp-phone',
  },
  {
    label: 'Link - Email',
    description:
      'Sign in/up using link sent to email (Requires the Passwordless recipe to be initialized)',
    id: 'link-email',
  },
  {
    label: 'Link - Phone',
    description:
      'Sign in/up using link sent to phone (Requires the Passwordless recipe to be initialized)',
    id: 'link-phone',
  },
  {
    label: 'Third Party',
    description:
      'Sign in/up using third party providers (Requires the ThirdParty recipe to be initialized)',
    id: 'thirdparty',
  },
];
