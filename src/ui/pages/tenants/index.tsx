...
const TenantList = ({
  ...
  const [isCreateTenantDialogOpen, setIsCreateTenantDialogOpen] =
    useState(false);
  ...
  const totalTenantsCount = Array.isArray(filteredTenants)
  ...
  return (
    <div className='tenants-container'>
      ...
      <p className='text-small tenants-subtitle'>
        One place to manage all your tenants. Create or edit tenants and their
        login methods according to your needs.
      </p>
