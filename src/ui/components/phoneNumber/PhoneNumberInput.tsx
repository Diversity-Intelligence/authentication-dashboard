...
const calculateOptionDropdownPosition = (
  countrySelectRef: React.RefObject<HTMLDivElement>,
) => {
...
export const PhoneNumberCountrySelect: FC<PhoneNumberCountrySelectProps> = (
  ...
  const getRowOptionheight = () =>
    countrySelectPopupRef.current?.querySelector(
  ...
  useEffect(() => {
    ...
    window.addEventListener('scroll', updateDropdownOptionPosition, {
      passive: true,
    });
    return () =>
      window.removeEventListener('scroll', updateDropdownOptionPosition);
    ...
    >
        ...
        <Icon
          ...
          label={
            selectedValue !== undefined
              ? getCountryCallingCode(selectedValue)
              : ''
          }
        />
        <span>
      ...
      <div
        ...
        style={{
          ...
          left: undefined,
          transform:
            popUpPosition?.positionType === 'top'
              ? 'translateY(-100%)'
              : undefined,
