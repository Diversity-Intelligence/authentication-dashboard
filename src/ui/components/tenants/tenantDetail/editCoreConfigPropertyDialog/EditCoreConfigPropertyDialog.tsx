...
export const EditCoreConfigPropertyDialog = ({
  ...
  const handleSaveProperty = async () => {
    try {
      setIsLoading(true);
      const parsedValue =
        type === 'number' && typeof currentValue === 'string'
          ? parseInt(currentValue)
          : currentValue;
      const res = await updateCoreConfig(
        tenantInfo.tenantId,
        name,
        parsedValue,
      );
        ...
        <div>
          ...
          <div
            className={`edit-config-property-value-container ${
              type === 'boolean'
                ? 'edit-config-property-value-container--row'
                : ''
            }`}
          >
          ...
          <div className='block-info block-medium text-small edit-config-property-description'>
            <div className='edit-config-property-description__info-pill'>
              Info
            </div>
            <p>{description}</p>
