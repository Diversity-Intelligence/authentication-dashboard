...
import { FactorIds, PUBLIC_TENANT_ID } from 'consts';
import { noTenants as NoTenantFound } from 'assets';
...
export const TenantDetail = ({
  ...
  const [isNoProviderAddedDialogVisible, setIsNoProviderAddedDialogVisible] =
    useState(false);
  ...
  const tenantHasThirdPartyEnabled = tenant?.firstFactors?.includes(
    FactorIds.THIRDPARTY,
  );
  const prevTenantHasThirdPartyEnabled = usePrevious(
