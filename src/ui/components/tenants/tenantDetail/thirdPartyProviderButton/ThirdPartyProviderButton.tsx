...
type ThirdPartyProviderButtonPropsWithIcon =
  ThirdPartyProviderButtonPropsBase & {
    icon: string;
    type?: 'with-icon';
  };

type ThirdPartyProviderButtonPropsWithoutIcon =
  ThirdPartyProviderButtonPropsBase & {
    type: 'without-icon';
  };
...
export const ThirdPartyProviderButton = (
  props: ThirdPartyProviderButtonProps,
) => {
  return (
    <button
