...
export const ProviderListDialog = ({
  ...
  return (
    ...
    >
      <DialogContent>
        <div>
          <h2 className='provider-list-title'>
            Add new Social / Enterprise Login Provider
          </h2>
          <hr className='provider-list-divider' />
          <div className='provider-list-header'>
            Select the Provider that you want to add for you tenant from the
            list below
          </div>
          <div className='provider-list-container'>
            <h2 className='provider-list-container__header-with-divider'>
              Enterprise Providers (OAuth)
            </h2>
            <div className='provider-list-container__providers-grid'>
              {IN_BUILT_THIRD_PARTY_PROVIDERS.filter(
                (provider) => provider.isEnterprise,
              ).map((provider) => {
                return (
