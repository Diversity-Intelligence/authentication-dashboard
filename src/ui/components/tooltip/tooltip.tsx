...
type TooltipPopupProps = TooltipBaseProps & {
  properties?: PopUpPositionProperties;
};
...
export const TooltipPopup: FC<TooltipPopupProps> = ({
  ...
  const width =
    properties?.positionType === 'left' || properties?.positionType === 'right'
      ? `${tooltipWidth}px`
      : 'auto';
